...
const toastVariants = cva(
  [
    ...
    'space-x-4 overflow-hidden rounded-lg p-6 pr-8 shadow-lg',
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      'group-[.destructive]:border-red-100 group-[.destructive]:hover:border-red-100',
      'group-[.destructive]:hover:bg-red-100 group-[.destructive]:hover:text-red-600',
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      ...
      'hover:text-gray-900 focus:opacity-100 focus:outline-none',
      'focus:ring-2 focus:ring-gray-400 focus:ring-offset-2',
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn('text-sm font-semibold text-gray-900 dark:text-gray-50', className)}
    {...props}
  />
));
